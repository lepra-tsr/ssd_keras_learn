...
def SSD300(input_shape, num_classes=21):
    ...
    net['pool1'] = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool1')(net['conv1_2'])
    ...
    net['pool2'] = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool2')(net['conv2_2'])
    ...
    net['pool3'] = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool3')(net['conv3_3'])
    ...
    net['pool4'] = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool4')(net['conv4_3'])
    ...
    net['pool5'] = MaxPooling2D(pool_size=(3, 3), strides=(1, 1), padding='same', name='pool5')(net['conv5_3'])
    ...
    # calc flatten loc
    num_priors = 3
    net['conv4_3_norm_mbox_loc'] = Conv2D(num_priors * 4, (3, 3), padding='same', name='conv4_3_norm_mbox_loc')(net['conv4_3_norm'])
    net['conv4_3_norm_mbox_loc_flat'] = Flatten(name='conv4_3_norm_mbox_loc_flat')(net['conv4_3_norm_mbox_loc'])
    # calc flatten conf
    name = getName(name='conv4_3_norm_mbox_conf', num_classes=num_classes)
    net['conv4_3_norm_mbox_conf'] = Conv2D(num_priors * num_classes, (3, 3), padding='same', name=name)(net['conv4_3_norm'])
    net['conv4_3_norm_mbox_conf_flat'] = Flatten(name='conv4_3_norm_mbox_conf_flat')(net['conv4_3_norm_mbox_conf'])
    # calc prior-box
    net['conv4_3_norm_mbox_priorbox'] = PriorBox(img_size, 30.0, aspect_ratios=[2],
    ...
    # calc flatten conf
    name = getName(name='fc7_mbox_conf', num_classes=num_classes)
    ...
    # calc prior-box
    net['fc7_mbox_priorbox'] = PriorBox(img_size, 60.0, max_size=114.0, aspect_ratios=[2, 3],
                                        variances=[0.1, 0.1, 0.2, 0.2],
    ...
    # calc flatten loc
    num_priors = 6
    net['conv6_2_mbox_loc'] = Conv2D(num_priors * 4, (3, 3), padding='same', name='conv6_2_mbox_loc')(net['conv6_2'])
    net['conv6_2_mbox_loc_flat'] = Flatten(name='conv6_2_mbox_loc_flat')(net['conv6_2_mbox_loc'])
    # calc flatten conf
    name = getName(name='conv6_2_mbox_conf', num_classes=num_classes)
    net['conv6_2_mbox_conf'] = Conv2D(num_priors * num_classes, (3, 3), padding='same', name=name)(net['conv6_2'])
    net['conv6_2_mbox_conf_flat'] = Flatten(name='conv6_2_mbox_conf_flat')(net['conv6_2_mbox_conf'])
    # calc prior-box
    net['conv6_2_mbox_priorbox'] = PriorBox(img_size, 114.0, max_size=168.0, aspect_ratios=[2, 3],
                                            variances=[0.1, 0.1, 0.2, 0.2],
    ...
    # calc flatten loc
    num_priors = 6
    net['conv7_2_mbox_loc'] = Conv2D(num_priors * 4, (3, 3), padding='same', name='conv7_2_mbox_loc')(net['conv7_2'])
    net['conv7_2_mbox_loc_flat'] = Flatten(name='conv7_2_mbox_loc_flat')(net['conv7_2_mbox_loc'])
    # calc flatten conf
    name = getName(name='conv7_2_mbox_conf', num_classes=num_classes)
    net['conv7_2_mbox_conf'] = Conv2D(num_priors * num_classes, (3, 3), padding='same', name=name)(net['conv7_2'])
    net['conv7_2_mbox_conf_flat'] = Flatten(name='conv7_2_mbox_conf_flat')(net['conv7_2_mbox_conf'])
    # calc prior-box
    net['conv7_2_mbox_priorbox'] = PriorBox(img_size, 168.0, max_size=222.0, aspect_ratios=[2, 3],
                                            variances=[0.1, 0.1, 0.2, 0.2],
    ...
    # calc flatten loc
    num_priors = 6
    net['conv8_2_mbox_loc'] = Conv2D(num_priors * 4, (3, 3), padding='same', name='conv8_2_mbox_loc')(net['conv8_2'])
    net['conv8_2_mbox_loc_flat'] = Flatten(name='conv8_2_mbox_loc_flat')(net['conv8_2_mbox_loc'])
    # calc flatten conf
    name = getName(name='conv8_2_mbox_conf', num_classes=num_classes)
    net['conv8_2_mbox_conf'] = Conv2D(num_priors * num_classes, (3, 3), padding='same', name=name)(net['conv8_2'])
    net['conv8_2_mbox_conf_flat'] = Flatten(name='conv8_2_mbox_conf_flat')(net['conv8_2_mbox_conf'])
    # calc prior-box
    net['conv8_2_mbox_priorbox'] = PriorBox(img_size, 222.0, max_size=276.0, aspect_ratios=[2, 3],
                                            variances=[0.1, 0.1, 0.2, 0.2],
    ...
    name = getName(name='pool6_mbox_conf_flat', num_classes=num_classes)
    ...
    net['pool6_mbox_priorbox'] = PriorBox(img_size, 276.0, max_size=330.0, aspect_ratios=[2, 3],
                                          variances=[0.1, 0.1, 0.2, 0.2],
                                          name='pool6_mbox_priorbox')(net['pool6_reshaped'])
...
def getName(name, num_classes):
    if num_classes == 21:
        return name
    else:
        return name + '_{}'.format(num_classes)
